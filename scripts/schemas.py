...
def schema_params():
    schema_params = {'attacking': {
                ...
                'midfielders': {'General': ['npxGA per 90', 'Successful defensive actions per 90', 'PAdj Interceptions', 'Duels per 90', 'Duels won, %', 'Progressive runs per 90', 'Accelerations per 90', 'Forward passes per 90', 'Accurate forward passes, %', 'Through passes per 90', 'Key passes per 90', 'Progressive passes per 90', 'Passes to final third per 90']}
                }
