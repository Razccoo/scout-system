...
def get_params_list():
    return [
        'Goller', 'Beklenen Gol (xG)', 'Asistler', 'Beklenen Asist (xA)', 'İkili Mücadeleler / 90',
        'Kazanılan İkili Mücadeleler %', 'Başarılı Savunma Eylemleri / 90', 'Savunma İkili Mücadeleleri / 90',
        'Kazanılan Savunma İkili Mücadeleleri %', 'Hava Mücadeleleri / 90', 'Kazanılan Hava Mücadeleleri %',
        'Top Çalma / 90', 'Top Çalma (pAdj)', 'Engellenen Şutlar / 90', 'Top Kesme / 90',
        'Top Kesme (pAdj)', 'Fauller / 90', 'Sarı Kartlar', 'Sarı Kartlar / 90', 'Kırmızı Kartlar',
        'Kırmızı Kartlar / 90', 'Başarılı Hücum Hareketleri / 90', 'Goller / 90', 'Penaltısız Goller',
        'Penaltısız Goller / 90', 'Beklenen Gol (xG) / 90', 'Kafa Golleri', 'Kafa Golleri / 90',
        'Şutlar', 'Şutlar / 90', 'Hedefi Bulan Şutlar %', 'Gol/ Şut %', 'Asist / 90', 'Ortalar / 90',
        'Başarılı Orta %', 'Sol Kanattan Ortalar / 90', 'Sol Kanattan Başarılı Ortalar %',
        'Sağ Kanattan Ortalar / 90', 'Sağ Kanattan Başarılı Ortalar %', 'Kaleci Kutusuna Ortalar / 90',
        'Dribblingler / 90', 'Başarılı Dribbling %', 'Hücum İkili Mücadeleleri / 90',
        'Kazanılan Hücum İkili Mücadeleleri %', 'Ceza Sahasında Dokunuşlar / 90', 'Kademeli Taşımalar / 90',
        'Topla Hizlanmalar / 90', 'Alınan Paslar / 90', 'Alınan Uzun Paslar / 90', 'Kazanılan Fauller / 90',
        'Paslar / 90', 'Başarılı Pas %', 'İleri Paslar / 90', 'Başarılı İleri Paslar %', 'Geri Paslar / 90',
        'Başarılı Geri Paslar %', 'Kısa / Orta Paslar / 90', 'Başarılı Kısa / Orta Paslar %', 'Uzun Paslar / 90',
        'Başarılı Uzun Paslar %', 'Ortalama Pas Uzunluğu, m', 'Ortalama Uzun Pas Uzunluğu, m',
        'Beklenen Asist (xA) / 90', 'Şut Asistleri / 90', 'İkinci Asist / 90', 'Üçüncü Asist / 90',
        'Akıllı Paslar / 90', 'Başarılı Akıllı Pas %', 'Anahtar Paslar / 90', 'Son Üçüncüye Paslar / 90',
        'Son Üçüncüye Başarılı Paslar %', 'Ceza Sahasına Paslar / 90', 'Ceza Sahasına Başarılı Paslar %',
        'Ara Paslar / 90', 'Başarılı Ara Paslar %', 'Derin Tamamlamalar / 90', 'Derin Tamamlanan Ortalar / 90',
        'Kademeli Paslar / 90', 'Başarılı Kademeli Paslar %', 'Başarılı Dikey Paslar %', 'Dikey Paslar / 90',
        'Yenilen Goller', 'Yenilen Goller / 90', 'Karşı Şutlar', 'Karşı Şutlar / 90', 'Gol Yememe',
        'Kurtarış Oranı %', 'Karşı Beklenen Gol (xG)', 'Karşı Beklenen Gol (xG) / 90', 'Engellenen Goller',
        'Engellenen Goller / 90', 'Kaleciye Geri Paslar / 90', 'Çıkışlar / 90', 'Hava Mücadeleleri / 90.1',
        'Serbest Vuruşlar / 90', 'Direkt Serbest Vuruşlar / 90', 'Direkt Serbest Vuruşlar Hedef %',
        'Kornerler / 90', 'Kullanılan Penaltılar', 'Penaltı Dönüşümü %', 'Top Çalma & Kesmeler (pAdj) / 90',
        '1., 2., 3. Asistler', 'xA başına Şut Asisti', 'Kazanılan Hava Mücadeleleri / 90', 'Kartlar / 90',
        'Gol Yememe %', 'npxG', 'npxG / 90', 'Şut Başına npxG', 'Dikey Pas %'
    ]
...
def get_column_mapping():
    return {
        ...
        "Non-penalty goals per 90": "Penaltısız Goller / 90", "xG per 90": "Beklenen Gol (xG) / 90", "Head goals": "Kafa Golleri", "Head goals per 90": "Kafa Golleri / 90",
        "Shots": "Şutlar", "Shots per 90": "Şutlar / 90", "Shots on target, %": "Hedefi Bulan Şutlar %", "Goal conversion, %": "Gol/ Şut %",
        "Assists per 90": "Asist / 90", "Crosses per 90": "Ortalar / 90", "Accurate crosses, %": "Başarılı Orta %", "Crosses from left flank per 90": "Sol Kanattan Ortalar / 90",
        "Accurate crosses from left flank, %": "Sol Kanattan Başarılı Ortalar %", "Crosses from right flank per 90": "Sağ Kanattan Ortalar / 90",
        "Accurate crosses from right flank, %": "Sağ Kanattan Başarılı Ortalar %", "Crosses to goalie box per 90": "Kaleci Kutusuna Ortalar / 90",
        "Dribbles per 90": "Dribblingler / 90", "Successful dribbles, %": "Başarılı Dribbling %", "Offensive duels per 90": "Hücum İkili Mücadeleleri / 90",
        "Offensive duels won, %": "Kazanılan Hücum İkili Mücadeleleri %", "Touches in box per 90": "Ceza Sahasında Dokunuşlar / 90",
        "Progressive runs per 90": "Kademeli Taşımalar / 90", "Accelerations per 90": "Topla Hizlanmalar / 90", "Received passes per 90": "Aldığı paslar / 90", 
        "Received long passes per 90": "Alınan Uzun Paslar / 90", "Fouls suffered per 90": "Kazanılan Fauller / 90", "Passes per 90": "Paslar / 90",
        "Accurate passes, %": "Başarılı Pas %", "Forward passes per 90": "İleri Paslar / 90", "Accurate forward passes, %": "Başarılı İleri Paslar %",
        "Back passes per 90": "Geri Paslar / 90", "Accurate back passes, %": "Başarılı Geri Paslar %",
