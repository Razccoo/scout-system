...
def generate_mplsoccer_radar_chart(player_data, player_names, player_teams, metrics, radar_high, radar_low):
    ...
    fig.figimage(twitter_icon, 600, 200, zorder=3, alpha=1)  # Position the icon at the bottom left of the figure

    # Add your Twitter handle
    fig.text(0.5, 0.10, '@AlfieScouting', fontsize=12, ha='center', va='center', color='#FFFFFF')
