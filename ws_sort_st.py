...
def scout_report(data_frame, gender, league, season, xtra, template, pos, player_pos, mins, minplay, compares, name, ws_name, team, age, sig, extra_text):
    ...
    column_mapping = {
        ...
        'defensive': {
            'defpct1': 'Savunma\nEylemleri',
            'defpct2': "Top Çalma\n(pAdj)",
            'defpct3': "Kazanılan Defansif\nİkili Müc. %",
            'defpct6': "Şut Engelleri",
            'defpct7': "Top Kapmalar\n(pAdj)",
            'extrapct7': 'Kazanılan\nHava Müc.',
            'defpct8': "Kazanılan\nHava Müc. %",
            'defpct9': "Uzun\nPas %",
            'extrapct10': 'Ortalar',
    ...
    if callout == 'Per 90':
        callout_text = "90' başına"
        title_note = ' & 90 Dk Başına Değerler'
    elif callout == 'Percentile':
        callout_text = 'yüzdelik dilim'
    ...
    plt.annotate(f"Çubuklar yüzdelik dilimlerdir | Gösterilen değerler {callout_text} değerleridir\nTüm değerler 90 dk başına | %s\n%s %s karşısında, %i+ dk\nData: Wyscout | %s\nSample Size: %i players" %(extra_text, league, compares, mins, sig, len(dfProspect)),
    ...
    if season in ['22-23','2023','23-24','2024']:
        ...
        clubpath = "https://github.com/IMG_5104-modified.png"
